 ...
 * The command that ...
 */
public class ExtendBallHolder extends BallHolderCommandBase {
     ...
     */
    public ExtendBallHolder(BallHolderSubsystem ballholder) {
        super(ballholder);
    }
     ...
     */
    public ExtendBallHolder(BallHolderSubsystem ballholder, double duration) {
